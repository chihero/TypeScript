...
declare namespace ts {
    namespace server {
        ...
        abstract class Project implements LanguageServiceHost, ModuleResolutionHost {
            ...
            resolveModuleNames(moduleNames: string[], containingFile: string, reusedNames?: string[], redirectedReference?: ResolvedProjectReference, _options?: CompilerOptions, containingSourceFile?: SourceFile, resolutionInfo?: ModuleResolutionInfo): ts.ResolvedModuleWithFailedLookupLocations[];
            getModuleResolutionCache(): ModuleResolutionCache | undefined;
            resolveTypeReferenceDirectives(typeDirectiveNames: string[] | FileReference[], containingFile: string, redirectedReference?: ResolvedProjectReference, _options?: CompilerOptions, containingFileMode?: ResolutionMode, resolutionInfo?: TypeReferenceDirectiveResolutionInfo): ts.ResolvedTypeReferenceDirectiveWithFailedLookupLocations[];
