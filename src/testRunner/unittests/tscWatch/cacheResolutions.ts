import { getPkgImportContent, getPkgTypeRefContent, getWatchSystemWithNode16, getWatchSystemWithNode16WithBuild, getWatchSystemWithOut, getWatchSystemWithOutWithBuild } from "../tsbuild/cacheResolutionsHelper";
